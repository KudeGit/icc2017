...
The first algorithm adopted to find patterns is based on the sequential rule mining algorithm \cite{algorithms}.
However, since this algorithm discovers the frequent correlated patterns only, it has been modigied in order to cover the infrequent mutually dependent patterns as well. 
...
The new algorithm, called Sequential-Pattern-discovery or SPD is described in fig.\ref{SPD}.
